...
<html>
  ...
  <br>  <br>  <br>
  <h1 style="text-align : center;">登入界面</h1>
  <br>  <br>
  <body background="../imgs/9.jpg">
  		<table id="tb7"  align="center">
  			<tr >
  				<td colspan="2" style="text-align : center;color : #EEC900;">用户登入</td>
  			</tr>
  			<tr>
  				<td>
  					账号 : 
  				...
  				<td style="width : 340px;">
  					<input type="text" name="userId"  id="userId"><span style="color : red; text-size: 18px;" id="if1"></span>
  				</td>
  			</tr>
  			<tr>
  				<td>
  ...
  <script type="text/javascript">
	...
	window.onload=function(){
		document.getElementById("login").onclick=function(){
			var flag = true;
			console.log(document.getElementsByName('userId')[0].value); //可以得到值
			if(document.getElementsByName('userId')[0].value != "" && document.getElementsByName('userId')[0].value != null ){
				console.log("不等于空");
			}else{
			...
			if(document.getElementsByName('password')[0].value != "" && document.getElementsByName('password')[0].value != null ){
	    	 ...
	    	 xhr.open("POST","http://localhost:8080/day00_00NetStore/servlet/CustomerServlet?time="+new Date().getTime()+"&open=login");
